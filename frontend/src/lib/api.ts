...
export const budgetApi = {
  ...
  update: (id: string, data: any) => api.put(`/budgets/${id}`, data).then(res => res.data),
...
export const actualExpenseApi = {
  ...
  create: (budgetId: string, data: any) => api.post(`/budgets/${budgetId}/actual-expenses`, data).then(res => res.data),
  update: (id: number, data: any) => api.put(`/actual-expenses/${id}`, data).then(res => res.data),
...
export const memberApi = {
  ...
  create: (data: any) => api.post("/members", data).then(res => res.data),
  update: (id: number, data: any) => api.put(`/members/${id}`, data).then(res => res.data),
...
export const purchaseApi = {
  ...
  create: (data: any) => api.post("/purchases", data).then(res => res.data),
  update: (id: number, data: any) => api.put(`/purchases/${id}`, data).then(res => res.data),
