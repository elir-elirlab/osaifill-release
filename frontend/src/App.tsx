...
function App() {
  ...
  const [showImportDialog, setShowImportDialog] = useState<any>(null)
  const [showActualExpenseSettings, setShowActualExpenseSettings] = useState<any>(null)
          ...
          <div className="flex flex-col gap-10">
            ...
            <section className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex items-center justify-between mb-6">
                <h1 className="text-ui-h1 font-bold tracking-tight">{t('dashboard')} - {activeDataset?.name}</h1>
              </div>
