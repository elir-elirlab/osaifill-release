...
import { Trash2, Upload, Settings, ReceiptJapaneseYen } from "lucide-react";
...
interface BudgetCardProps {
  ...
  onRefresh: () => void;
  onImport: (budget: any) => void;
  onEditActual: (budget: any) => void;
  onEdit: (budget: any) => void;
}

export function BudgetCard({ budget, onRefresh, onImport, onEditActual, onEdit }: BudgetCardProps) {
